...
abstract class Model { //Versi 3_1: Tambah jsonColumns
...
//    if (static::$_publicProps != null) return static::$_publicProps;
  ...
  public static function findWhere($strWhere, $cols='*', $bindings=[]) {
    $sql = "SELECT $cols FROM ".static::tableName()." $strWhere";
    $baris = DB::getOneRow($sql, $bindings);
...
//    }
  ...
  public static function count() {
    return (int) DB::getOneVal('SELECT COUNT(*) FROM '.static::tableName());
  }
  public static function countPlus($strWhere, $bindings=[]) {
    return (int) DB::getOneVal('SELECT COUNT(*) FROM '.static::tableName()." $strWhere", $bindings);
  }
}
