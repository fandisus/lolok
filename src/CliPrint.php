...
class CliPrint {
  ...
  public static function formatPrintLn(array $format=[], string $text='') {
    self::formatPrint($format, $text); echo "\r\n";
  }
  public static function printError($message) {
    self::formatPrint(['redbg', 'white', 'bold'], 'Error');
    self::formatPrintLn(['yellow', 'bold'], ' '.$message."\r\n");
  }
  public static function printSuccess($message) {
    self::formatPrint(['greenbg', 'black'], 'Success');
    self::formatPrintLn(['yellow', 'bold'], ' '.$message."\r\n");
  }
  public static function printInfo($message) {
    self::formatPrint(['cyanbg', 'black'], 'Info');
    self::formatPrintLn(['white', 'bold'], ' '.$message);
  }
}